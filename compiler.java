...
//			System.out.println(word.get(i)+" "+wsym[i]);
	...
	public static void error(int i)
	{
		...
		{
		case 1:
			System.out.println("Error 1:C0File cannot open!");
			break;
		case 2:
			System.out.println("Error 2:ident cannot be distinguished");
			break;
		case 3:
			System.out.println("Error 3:Program too long,cannot generate instruct!table overflow");
			break;
		case 4:
			System.out.println("Error 4:after ident variable's comma should  be ident variable.");
			break;
		case 5:
			System.out.println("Error 5:after ident variables  should  be semicolon.");
			break;
		case 6:
			System.out.println("Error 6:lose ')'");
			break;
		case 7:
			System.out.println("Error 7:lose '{'.");
			break;
		case 8:
			System.out.println("Error 8:should be ',' or ';'");
			break;
		case 9:
			System.out.println("Error 9:should be ident");
			break;
		case 10:
			System.out.println("Error 10:Not Found ident.");
			break;
		case 11:
			System.out.println("Error 11:lose '('");
			break;
		case 12:
			System.out.println("Error 12:lose '}'.");
			break;
		case 13:
			System.out.println("Error 13:lose ';'.");
			break;
		case 14:
			System.out.println("Error 14:assign statement lose '='.");
			break;
		case 15:
			System.out.println("Error 15:factor error.");
			break;
		case 16:
			System.out.println("Error 16:int_function didn't define return type.");
			break;
		}
	}
}
